          ...
          <div className={styles.embla__slide}>
            ...
            >
              <div className={styles["about__section--desc"]}>
                <h2>Myself</h2>
                <p>
                  Hello! My name is Luke and I love creating things that live on
                  the internet. I&#39;m a full stack developer based in Bristol.
                  I&#39;ve always had a love for techincal challenges.
                  <br></br>
            ...
            >
              <div className={styles["about__section--desc"]}>
                ...
                <p>
                  ...
                  for WordPress websites along with WebPack and Node for backend
                  shinanigans
                </p>
                <br></br>
                <p>
                  - My favourite programming launguage to work with is{" "}
                  <bold>React</bold> due to its simplicity and ease of use.
                </p>
              </div>
              <div>
                <Image
